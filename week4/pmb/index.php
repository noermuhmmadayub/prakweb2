...
// cek terlebih dahulu apakah user sudah submit from login atau belum
...
if (isset($_POST['login'])){
    ...
    // validasi username dan passwoednya disini
if ($username == "ayub" && $password == "12345"){
    // jika username dan password sama, arahkan ke file home.php
    $_SESSION['username'] = $username;
    header("location: home.php");
    exit();
}else{
    // jika username dan password beda, rampilkan pesan error username salah
